 ...
 * @author andri
 */
public class KreirajTerminSmeneSO extends ApstraktnaGenerickaOperacija {

    @Override
    protected void preduslovi(Object param) throws Exception {
        if (param == null || !(param instanceof TerminSmene)) {
            throw new Exception("Sistem ne može da kreira termin smene - neispravan parametar.");
        }
